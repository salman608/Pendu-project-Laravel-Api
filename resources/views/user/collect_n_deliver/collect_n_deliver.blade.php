...
@endif
    ...
    <div class="container task-body mt-3" >
                        ...
                        <table class="table table-borderless border-top-0">
                            <tbody>
                                <tr class="top border-bottom border-light" id="tableRow_1">
                                    ...
                                    <td class="p-name"><input class="form-control pro-name" type="text" name="pro_name[]" id="pname" placeholder="Enter Product Name..."></td>
                                    <td class="qty">
...
$('#add_btn').on('click',function(){
    ...
    html+='<td class="text-right cross"><button type="button" class="cross-button" id="remove"></button></td>';
    html+='</tr>';
    $('tbody').append(html);
});
