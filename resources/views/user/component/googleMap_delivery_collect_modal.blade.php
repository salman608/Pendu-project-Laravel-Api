...
{{-- google map modal --}}
<div class="modal fade bd-example-modal-lg" id="googleMapDeliveryCollectModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" >
