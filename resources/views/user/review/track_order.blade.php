        ...
        <div class="row track_div" id="track_div" style="background: #fff; box-shadow: 0px 3px 6px rgba(0, 0, 0, 13);border-radius: 10px;margin-bottom: 30px;padding-bottom: 20px;margin:auto;">
            ...
            <div class="col-md-12 col-sm-12 col-lg-12">
                    ...
                    <div class="row w-100 d-flex justify-content-center  mb-5">
                        <p id="show-track-error" style="color: red; font-size: 17px;">Please enter a valid order id</p>
                    </div>
...
// Show Track Status
    $('#track-now-btn').on('click',function(){

        let orderId = $("#orderId").val();

        if(orderId == ''){

            $("#show-track-error").css('display','block');
        ...
        $.ajax({
            ...
            success: function(data){
                if($.isEmptyObject(data) != null){
                    ...
                    $("#show-track-error").css('display','none');
