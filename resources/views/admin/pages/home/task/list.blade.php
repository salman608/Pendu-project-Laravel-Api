    ...
    <div class="page-content">
        <div class="row">
            <div class="d-flex justify-content-end mb-1">
                <span class="mt-2 mr-5">Sort by &emsp;</span>
                <select name="" id="" class="choices form-select" style="width: 100px">
                        ...
                        <table class="table">
                            <thead>
                                <tr class="row100 head">
                                    <th class="cell100 sl-column">SL#</th>
                                    <th class="cell100 prod-column">Product ID</th>
                                    <th class="cell100">Category</th>
                                    <th class="cell100">Timeframe</th>
                                    <th class="cell100">Driver Name</th>
