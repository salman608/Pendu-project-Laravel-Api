...
{{-- google map modal --}}
<div class="modal fade bd-example-modal-lg" id="googleMapPicupCollectModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body popUpImage position-relative" style="padding: 0">
                ...
                <div style="margin: 5 25 20 25;">
                    ...
                    <button type="button" id="picupCollectModalBtn" class="button text-white" style="margin-top: -10px;width: 100%">Select Picup Point</button>
                </div>
            </div>
        </div>
    </div>
