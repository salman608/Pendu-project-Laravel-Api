            ...
            <div class="modal-body ">
              <div class="reg_form profile_info_form">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control form-control-lg reg_name_input" value="{{Auth::user()->name}}" name="name">
                  ...
                  <div class="form-group">
                    ...
                    <label class='reg_sub profile_sub' for="  ">Suburb</label>
                  </div>

                  <div class="form-group">
                    <input type="text" class="form-control form-control-lg reg_phn_input" value="{{Auth::user()->phone}}" name="phone">
                    <label class='reg_phn profile_phn' for="  ">Phone</label>
                  </div>

                  {{-- <div class="form-group">
                    <input type="password" class="form-control form-control-lg reg_pass_input" id=" " >
                    <label class='reg_pass profile_pass' for="  ">Password</label>
                  </div> --}}

                  <div class="form-group">
                      <div class="row">
                          <div class="col-8">
                              <input type="file" class="form-control form-control-lg reg_image_input" name="profile_image">
                              <label class='reg_image' for="">Image</label>
                          </div>
                          {{-- <div class="col-4">
                              <img style="height: 50px;width: 50px;border-radius: 25px;" src="{{Auth::user()->image?asset(Auth::user()->name):'https://ui-avatars.com/api/?name='.Auth::user()->name}}" alt="">
                          </div> --}}
                      </div>
                  </div>
