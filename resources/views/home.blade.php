    ...
    <div class="modal fade" id="reg_exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
         ...
         <!-- ===================== Hero Section ================= -->
         <section class="hero_section pb-5">
        ...
        <!-- ================== Service Section =============== -->
        <section class="service_home mt-3">
            <div class="container">
                <div class="row">
        ...
        <!-- ================================== Service Tech ================ -->
        <section class="service_tech mt-3 mt-md-4">
          <div class="container">
            <div class="row ">
              <div class="col-md-6 text-center order-sm-2 order-md-1 order-xl-1 order-1 tech_logo">
                <div class="qr_logo">
                  <img src="{{asset('frontend')}}/assets/images/Icons/qr_code.svg" alt="qr code">
                </div>

                <div class="tech_content mt-2">
              ...
              <div class="col-md-6  order-sm-1 order-md-2 order-xl-1 order-2 mt-3 ">
                <div class="tech_right_img">
        ...
        <section class="member_slider mt-5">
          ...
          <div class="container member_border ">
            ...
            <div class="owl-carousel owl-theme ">
              @foreach ($pro_drivers as $dropper)
              <div class="item">
                  ...
                  <div class="member_rating">
                    ...
                    <ul>
                      ...
                      <li class='ml-auto' >
                        ...
                        {{-- @foreach ($dropper->services as $service)
                            <img src="{{ $service->icon }}" style="width: 20px; height:20px" alt="" width="20" height="20">
                        @endforeach --}}
         ...
         <div class="container pb-2 key_border">
          <h4>Key feature of Pendu</h4>
           <div class="row kay_svg">
             ...
             <div class="col-md-3 col-lg-3 col-sm-6 col-6 text-center p-1 pl-lg-3">
               <div class="key_item">
                ...
                <p class='mt-1 key-feature'>Secures cashless payment</p>
               </div>
             ...
             <div class="col-md-3 col-lg-3 col-sm-6 col-6 text-center p-1">
               <div class="key_item">
                ...
                <p class='mt-1 key-feature'>Built in communications</p>
               </div>
